...
} from '@/shared/config/storybook/StoreDecorator/clientDetailsStoreDecorator'
...
export const NotFound: Story = {
    ...
    decorators: [WithColorsTheme, clientDetailsErrorStoreDecorator],
    parameters: {
        docs: {
            canvas: { sourceState: 'shown' },
        },
...
export const IsLoading: Story = {
    ...
    decorators: [WithColorsTheme, clientDetailsIsLoadingStoreDecorator],
    parameters: {
        docs: {
            canvas: { sourceState: 'shown' },
        },
