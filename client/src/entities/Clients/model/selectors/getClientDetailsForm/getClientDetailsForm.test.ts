...
import { getClientDetailsForm } from './getClientDetailsForm'
...
describe('getClientDetailData.test', () => {
    test('should return value', () => {
        ...
        expect(getClientDetailsForm(state as StateSchema)).toEqual(data)
    })
    test('with empty state', () => {
        const state : DeepPartial<StateSchema> = {}
        expect(getClientDetailsForm(state as StateSchema)).toEqual(undefined)
    })
})